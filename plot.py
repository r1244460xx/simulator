...
with open(filename,"r") as f:
    ...
    for i in range(init_server, max_server):        
        ...
        if i == init_server or i == max_server-1:
            ...
            plt.savefig(results_dir+"ss"+str(i), dpi=200)
            ...
            plt.savefig(results_dir+"ses"+str(i), dpi=200)
            ...
            plt.savefig(results_dir+"sus"+str(i), dpi=200)
            ...
            plt.savefig(results_dir+"aed"+str(i), dpi=200)
            ...
            plt.savefig(results_dir+"aap"+str(i), dpi=200)
            ...
            plt.savefig(results_dir+"aeap"+str(i), dpi=200)
            ...
            plt.savefig(results_dir+"auap"+str(i), dpi=200)
